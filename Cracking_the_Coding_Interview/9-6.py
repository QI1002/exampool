...
n = 4
offset = 11         
mat1 = genZigZagMatrix(m,n,offset, True)
mat2 = genZigZagMatrix(m,n,offset, False)
mat3 = genRowFirstMatrix(m,n,offset)
mat4 = genColumnFirstMatrix(m,n,offset)

mat = mat4
printMatrix(mat)
for i in range(offset-1, offset+m*n+1, 1): 
    print("find {0} in {1}".format(i, findInMatrix(mat, i)))
